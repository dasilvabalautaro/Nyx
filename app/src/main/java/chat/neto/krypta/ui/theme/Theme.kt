...
import chat.neto.krypta.ui.findActivity
...
/**
 * Tema Krypta: identidad propia verde-teal (marca reconocible, misma cara en todos los
...
fun KryptaTheme(
    ...
    // Iconos de las barras del sistema (hora, batería, red, notificaciones) según el tema
    // **resuelto de la app**, no el del sistema: como el tema es elegible por el usuario,
    // `enableEdgeToEdge()` por sí solo los pinta según el modo del móvil y, al forzar "Claro"
    // con el móvil en oscuro (o al revés), quedaban iconos blancos sobre barra clara =
    // invisibles. Se reevalúa en cada cambio de `darkTheme` (conmutación en caliente).
